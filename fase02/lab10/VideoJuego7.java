...
public class VideoJuego7 {
    public static void main(String[] args) {
        ...
        do {
            ...
            int[] filas1 = numerosRandom(ej1)[0];
            int[] columnas1 = numerosRandom(ej1)[1];

            int[] filas2 = numerosRandom(ej2)[0];
            int[] columnas2 = numerosRandom(ej2)[1];

            System.out.println("h");
            do {
                filas1 = numerosRandom(ej1)[0];
                columnas1 = numerosRandom(ej1)[1];

                filas2 = numerosRandom(ej2)[0];
                columnas2 = numerosRandom(ej2)[1];
            ...
            mostrarTablero(tablero);
            System.out.println(soldadosConVida(tablero, ejercito1));
            System.out.println(soldadosConVida(tablero, ejercito2));
    ...
    public static void iniciarEjercito(Soldado[] ar, int nro) {
    ...
    public static int[][] numerosRandom(int q) {
        ...
        for (int i = 0; i < q; i++) {
            ...
            } while (estaEnArreglo(x, y, x[i], y[i], i));
        }
        return nums;
    }
    ...
    public static boolean estaEnArreglo(int[] filas, int[] columnas, int x, int y, int index) {
        for (int i = 0; i < index; i++) {
            if (x == filas[i] && y == columnas[i]) {
                return false;
            }
        }
        return true;
    ...
    public static int soldadosConVida(Soldado[][] tb, Soldado[] ej) {
        int q = 0;
        for (int i = 0; i < tb.length; i++) {
            for (int j = 0; j < tb[i].length; j++) {
                Soldado s = tb[i][j];
                if (estaEnArreglo(ej, s)) {
                    q++;
                }
            }
        }
    ...
    public static boolean estaEnArreglo(Soldado[] ej, Soldado s) {
        for (int i = 0; i < ej.length; i++) {
            if (s.getNombre().equals(ej[i].getNombre())) {
                return true;
            }
        }
        return false;
